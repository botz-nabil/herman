...
async function starts() {
	...
	client.on('open', () => {
		success('2', 'Sukses, Sc by Herman Chanel')
	})
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./Herman.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
...
let settingstatus = 0;
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await client.setStatus(`Aktif selama ${uptime} | spam/vc/telfon?block | Sewa Bot Only |Subscribe Herman Chanel🗿`).catch((_) => _);
...
├❍ *Insta    : @nab.nab_27*
├❖ *Youtub : Gk Ada*
├❍ *LinkGb : https://chat.whatsapp.com/Hl3EIJ9U2mhBPEyVnSnN8O*
├❖ *LINK : Gk ada*
├❍ *wasap : wa.me/6281938835391*
├❖ *TAG : @${ptod.split("@")[0]}*
╰─────────────────────╯
...
var imgs = await client.prepareMessage('0@c.us', thumb, image, { thumbnail: thumb })
            ...
            var ctlg = await client.prepareMessageFromContent(from, {
                "productMessage": {
                    ...
                    "businessOwnerJid": "6288991078376@s.whatsapp.net",
                }
...
╰━━━━━━━━━━━━━━━━━`
            ...
            contentText: `_© By Herman Chanel_`,
